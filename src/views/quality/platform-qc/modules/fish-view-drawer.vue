    ...
    <div class="qc-detail">
      <div class="detail-section">
        ...
        <ElDescriptions :column="2" border>
          ...
          <ElDescriptionsItem label="杂交质控">
            <ElTag :type="rowData?.hybridizationQc === '合格' ? 'success' : rowData?.hybridizationQc === '不合格' ? 'danger' : 'info'" size="small">
              {{ rowData?.hybridizationQc || '-' }}
            </ElTag>
          </ElDescriptionsItem>
          <ElDescriptionsItem label="扫描质控">
            <ElTag :type="rowData?.scanQc === '合格' ? 'success' : rowData?.scanQc === '不合格' ? 'danger' : 'info'" size="small">
              {{ rowData?.scanQc || '-' }}
            </ElTag>
          </ElDescriptionsItem>
...
<script setup lang="ts">
  defineOptions({ name: 'FishViewDrawer' })
