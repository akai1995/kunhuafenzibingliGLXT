  ...
  <ElDrawer v-model="drawerVisible" title="编辑质控信息" size="600px">
    <ElForm :model="form" label-width="120px" ref="formRef" :rules="formRules">
      <ElRow :gutter="16">
        ...
        <ElCol :span="12">
          <ElFormItem label="粪便总量" prop="stoolAmount">
            <ElInput v-model="form.stoolAmount" placeholder="请输入粪便总量">
...
<script setup lang="ts">
  ...
  defineOptions({ name: 'StoolQcEditDrawer' })
  ...
  const formRules: FormRules = {
    stoolAmount: [{ required: true, message: '请输入粪便总量', trigger: 'blur' }],
